...
Eine weitere Methode war, alle anderen Gruppenmitglieder auf unserem Live-server 
Nach jedem neuen Feature wurde mithilfe von https://chrome.google.com/webstore/detail/advanced-rest-client/hgmloofddffdnphfgcellkdfbfbjeloo[ARC-Client] getestet. Man hat versucht, sich jegliche Nutzer Aktionen auszudenken und zu prüfen alles Fehlerfrei (außer die von uns geworfene Fehlern) laufen zu lassen.
...
** pug
* cors +
Es mussten cors aktiviert werden um
